    ...
    <div className="hero mt-20">
      <div className="hero-content text-center text-neutral-content">
        <div className="">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 justify-items-center">
            ...
            <div className="w-full p-6 text-white glass mb-10 md:mb-0 flex flex-col">
              ...
              <ul className='pb-4 flex-1'>
                ...
                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Standard video quality (up to 720p)</span>
                </li>

                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Offline downloads for a limited number of titles</span>
                </li>
              </ul>
              <hr />
              <div className='group:mb-0'>
                <button className="w-full text-red-700 border border-red-700 rounded font-semibold hover:bg-red-700 hover:text-white hover:shadow-xl transition duration-150 ease-in-out py-4 mt-4">Choose Plan</button>
              </div>
            </div>
            ...
            <div className="w-full p-6 text-white glass mb-10 md:mb-0 flex flex-col">
              ...
              <ul className='pb-4 flex-1'>
                ...
                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Access on two devices simultaneously</span>
                </li>

                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>High-definition video quality (up to 1080p)</span>
                </li>
              ...
              <hr />
              <button className="block w-full text-red-700 border border-red-700 rounded font-semibold hover:bg-red-700 hover:text-white hover:shadow-xl transition duration-150 ease-in-out py-4 mt-4 align-bottom">Choose Plan</button>
            </div>
            <div className="relative z-[1]">
              <div className="ribbon absolute -top-2 -left-2 h-40 w-40 overflow-hidden before:absolute before:top-0 before:right-0 before:-z-[1] before:border-4 before:border-blue-500 after:absolute after:left-0 after:bottom-0 after:-z-[1] after:border-4 after:border-blue-500">
                <div className="absolute -left-14 top-[43px] w-60 -rotate-45 bg-gradient-to-br from-blue-600 via-blue-400 to-blue-500 py-2.5 text-center text-white shadow-md">Most Popular</div>
              </div>
              ...
              <ul className='pb-4 list-disc'>
                ...
                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Access on up to four devices simultaneously</span>
                </li>

                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Ultra HD video quality (up to 4K)</span>
                </li>

                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Exclusive early access to new releases and original content</span>
                </li>
              </ul>
              <hr />
              <button className="w-full text-red-700 bg-white rounded opacity-75 hover:opacity-100 hover:shadow-xl transition duration-150 ease-in-out py-4 mt-4">Choose Plan</button>
            </div>
            </div>
            ...
            <div className="w-full p-6 text-white glass mb-10 md:mb-0 flex flex-col">
              ...
              <ul className='pb-4 flex-1'>
                ...
                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Simultaneous access on multiple devices (up to six)</span>
                </li>
                ...
                <li className="flex items-start text-left text-sm gap-2 font-thin mt-2">
                  <FaCheckDouble className='w-4' />
                  <span className='w-full'>Customizable profiles for each family member
                  </span>
                </li>
              </ul>
              <hr />
