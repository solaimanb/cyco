    ...
    <div className="md:w-[80%] mx-auto pt-28">
      <div className='text-center'>
        ...
        <p className="text-center py-4 text-sm md:text-base w-[60%] mx-auto">
          CYCO is a streaming platform. it's likely that it offers a range of
          movies, TV shows, and possibly other forms of entertainment content
          for users to watch online. Streaming platforms have become
          increasingly popular for their convenience and wide selection of
          content.
        </p>
      </div>
