...
const SubscriptionCard = ({ title, price, features, buttonText }) => {
  ...
  return (
    <div className="flex flex-col justify-between bg-zinc-700 w-full mx-auto p-6 rounded-md shadow-lg">
      <div>
        <div className="text-center">
          <h2 className="text-xl font-semibold text-white">{title}</h2>
          <p className="text-lg font-extrabold text-green-500">${price} / month</p>
        </div>
        <div className="mt-6">
          <ul className="text-gray-100 text-xs lg:text-sm">
